  ...
  <div class="process-container">
    <div>
      <el-form :inline="true" :model="filterForm" class="form-inline" label-width="100px">
        <el-form-item>
          <input
            style=" padding: 4px;width:16em;height:35px"
    ...
    >
      ...
      <el-table-column label="审查意见" :show-overflow-tooltip="true" width="100">
        <template slot-scope="scope">
          <template v-if="scope.row.td6===1" type="success" style="width:90%" disable-transitions>有</template>
        </template>
      </el-table-column>
      <el-table-column label="审核意见" :show-overflow-tooltip="true" width="100">
        <template slot-scope="scope">
          <template v-if="scope.row.td6===1" type="success" style="width:90%" disable-transitions>-</template>
      ...
      <el-table-column label="状态" :show-overflow-tooltip="true" width="100">
        <template slot-scope="scope">
          <el-tag
            v-if="indexRouter== '1'"
            type="success"
            style="width:90%;color:#484D77;color:#004D77;background-color:#A6F7BC;"
            disable-transitions
          >待复核</el-tag>
          <el-tag
            v-if="indexRouter== '2'"
            type="success"
            style="width:90%;color:#484D77;color:#00428C;background-color: #8CDDFE;"
            disable-transitions
          >待终审</el-tag>
        </template>
      </el-table-column>
      ...
      <el-table-column label="操作" width="200">
        <template slot-scope="scope">
          <el-button v-if="scope.row.td6===1" type="text" @click="checkDetail(scope.row)">查看</el-button>
        </template>
      </el-table-column>
    </el-table>
...
<script src="../secondCheck/checkResult.js"></script>
