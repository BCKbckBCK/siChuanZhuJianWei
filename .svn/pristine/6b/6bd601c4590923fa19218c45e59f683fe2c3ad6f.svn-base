<template>
  <div class="processDetail-container">
    <section style=";margin-top:20px;">
      <input type="text" class="explorationInputStyle" placeholder="输入关键字搜索项目" />
         <el-button type="primary" style="width:170px;margin-left:15px;vertical-align:botton">查询</el-button>
    </section>
    <el-table
