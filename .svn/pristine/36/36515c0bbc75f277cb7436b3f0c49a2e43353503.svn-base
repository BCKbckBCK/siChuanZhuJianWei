  ...
  <div class="process-container">
    ...
    >
      ...
      <el-table-column label="状态" :show-overflow-tooltip="true" width="150">
        <template slot-scope="scope">
          <el-tag v-if="indexRouter== '1'" type="success" style="width:90%">待复核</el-tag>
          <el-tag v-if="indexRouter== '2'" type="success" style="width:90%" disable-transitions>待终审</el-tag>
        </template>
      </el-table-column>
