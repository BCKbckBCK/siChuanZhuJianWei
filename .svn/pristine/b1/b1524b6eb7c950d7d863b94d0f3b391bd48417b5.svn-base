<template>
  <el-container class="login-container">
            ...
            <div style="width:1200px;margin:0 auto">
              <ul class="heras">
                ...
                <li style="vertical-align: middle;">
                  <span style="font-weight:600;font-size:20px;">工程建设项目施工图审查</span>
                </li>
                <!-- <li  style="vertical-align: middle;float: right;margin-top: 17px;">
                  <input id="realName" type="hidden" value />
                <input id="nickName" type="hidden" value />-->
                <!-- <ul id="loginInfo"> -->
                <!-- <li class="trat" style="vertical-align: -3px;">
                    <a href="/app/login" class="atvi" style="color: #4F8CEE;">
                      登录
                    </a>
                </li>-->

                <!-- <li class="" style="vertical-align: middle;" />
                  <li style="float:right;margin-left: 15px;cursor: pointer;">
                    <img id="Acontent_page" :src="tuichu_page" class="img_img2" style="">
                </li>-->
                <!-- </ul>
                </li>-->
                ...
                <li class="ewm">
                  <a href="http://www.sc.gov.cn/" target="_blank" class="fr">四川省人民政府网</a>
                </li>
                <li id="yidongduan_a">
                  <img :src="phone" style />
                  <div id="kill_oppo">
    ...
    <el-main>
      <div class="main workarea moveIn" style="display: block;min-height: auto;margin-top: -5px;">
          ...
          <div class="dvLogin">
            <ul>
              <li>
                <div>
                  <a
                    href="http://szst-gc.sczwfw.gov.cn/router.ashx?method=goOAuthSiChuan&amp;loginType=%E5%BB%BA%E8%AE%BE%E5%8D%95%E4%BD%8D"
                  >
                    <img :src="jsdw" />
                    <h3>建设单位登录</h3>
                    <p>业务申办</p>
              ...
              <li>
                <div>
                  <a
                    href="http://szst-gc.sczwfw.gov.cn/router.ashx?method=goOAuthSiChuan&amp;loginType=%E8%AE%BE%E8%AE%A1%E5%8D%95%E4%BD%8D"
                  >
                    <img :src="sjdw" />
                    <h3>勘察单位登录</h3>
                    <p>
              ...
              <li>
                <div>
                  <a
                    href="http://szst-gc.sczwfw.gov.cn/router.ashx?method=goOAuthSiChuan&amp;loginType=%E5%AE%A1%E5%9B%BE%E5%8D%95%E4%BD%8D"
                  >
                    <img :src="stjg" />
                    <h3>审图机构登录</h3>
                    <p>收件受理、任务指派、图纸审查</p>
              ...
              <li>
                <div>
                  <a href="http://59.225.209.241/zwlogin.jsp">
                    <img :src="glbm" />
                    <h3>主管部门登录</h3>
                    <p>了解分析监管审图业务情况</p>
                  </a>
      ...
      <div style="text-align: center;margin-top: 50px;">
        <a
          href="http://szst-gc.sczwfw.gov.cn/pdfseal/Ukey%20%E5%AE%A2%E6%88%B7%E7%AB%AF%20v1.24.exe"
        >国脉电子签章客户端下载</a>
      </div>
    </el-main>
            ...
            <ul class>
              ...
              <li>
                <a
                  ...
                  style="color:black"
                >
                  <img :src="foot_police" class="in-bl" />&nbsp;&nbsp;川公网安备 51010402000532号
                </a>
              </li>
...
export default {
  ...
  methods: {
    ...
    todesign() {
      ...
      // console.log(    JSON.parse(item)[0].progress)
